...
import kpiApiRouter from "./kpi-api-router";
import kpiassignmentsApiRouter from "./kpiassignments-api-router";
import n8nApiRouter from "./n8n-api-router";
...
api.use("/kpi", kpiApiRouter);
api.use("/n8n", n8nApiRouter);
api.use("/kpi-assignments", kpiassignmentsApiRouter);
