...
import { DropdownListKpisComponent } from 'app/administrator/kpis/dropdown-list-kpis/dropdown-list-kpis.component';
import { KpisModule } from 'app/administrator/kpis/kpis.module';
